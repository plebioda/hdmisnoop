...
#define NVIC_PRIORITY_GROUP_0	((uint32_t)0x700) /*!<  for pre-emption priority
                                                            4 bits for subpriority */
#define NVIC_PRIORITY_GROUP_1	((uint32_t)0x600) /*!< 1 bits for pre-emption priority
                                                            3 bits for subpriority */
#define NVIC_PRIORITY_GROUP_2	((uint32_t)0x500) /*!< 2 bits for pre-emption priority
                                                            2 bits for subpriority */
#define NVIC_PRIORITY_GROUP_3	((uint32_t)0x400) /*!< 3 bits for pre-emption priority
                                                            1 bits for subpriority */
#define NVIC_PRIORITY_GROUP_4	((uint32_t)0x300) /*!< 4 bits for pre-emption priority
